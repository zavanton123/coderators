...
class RegisterView(View):
    def get(self, request, *args, **kwargs):
        form = RegisterForm()
        return render(request, 'snippet/auth/register.html', context={'form': form})
...
class UserLoginView(LoginView):
    ...
    template_name = 'snippet/auth/login.html'
...
class UserPasswordChangeView(PasswordChangeView):
    ...
    template_name = 'snippet/auth/user_password_change.html'
...
class UserPasswordChangeDoneView(PasswordChangeDoneView):
    template_name = 'snippet/auth/user_password_change_done.html'


class UserPasswordResetView(PasswordResetView):
    template_name = 'snippet/auth/user_password_reset.html'
...
class UserPasswordResetDoneView(PasswordResetDoneView):
    template_name = 'snippet/auth/user_password_reset_done.html'


class UserPasswordResetConfirmView(PasswordResetConfirmView):
    template_name = 'snippet/auth/user_password_reset_confirm.html'
...
class UserPasswordResetCompleteView(PasswordResetCompleteView):
    template_name = 'snippet/auth/user_password_reset_complete.html'
